...
import graph.{DirectedEdge, traversal}
...
trait Traversal[V]:
   ...
   */
  protected val traversable: graph.traversal.Traversable[V]
  /**
 ...
 */
class DepthFirstTraversal[V](val source: V, val traversable: graph.traversal.Traversable[V]) extends Traversal[V]:
 ...
 * @tparam V type of elements to be traversed.
 */
class BreadthFirstTraversal[V](val source: V, val traversable: graph.traversal.Traversable[V]) extends Traversal[V]:
